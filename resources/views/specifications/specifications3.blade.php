      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 text-product">
            <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom">Aluminium Billet</h2>
            <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">Aluminium are cast in billets to make
              automotive, and aerospace parts and also for other applications
              like packaging, construction, electrical, and electronics. Aluminum billets can be produced out of primary
              and remelt or secondary aluminum.</p>
          </div>
          <div class="col-md-3 d-flex justify-content-center img-detail" data-aos="fade-left" data-aos-easing="linear"
            data-aos-duration="1500">
            <img src="/img/produk/billet.png" class="img-fluid" alt="...">
          </div>
        </div>
      </div>
    </div>
  ...
  <section>
    <div class="container specification-table">
      <div class="row">
        ...
        <div class="col">
          <img src="/img/ps/billet.jpg" class="img-fluid" alt="Responsive image" data-aos="zoom-out-left">
